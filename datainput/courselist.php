...
<div id="content">
	...
	<!--Write code here!-->
		...
		<h2 class="heading">Course List</h2>
		<?php  
			include_once('../db_config.php');
			$slQuery="SELECT coursecode,coursename,credits,department FROM coursemaster";
			if(isset($_GET['dept'])) {
				$dept=urldecode($_GET['dept']);
				echo "<h3>&nbsp;&nbsp;&nbsp;&nbsp;Department : $dept</h3>";
				$slQuery=$slQuery." where department = '$dept'"; 
			}
			$slQuery=$slQuery." order by coursecode";
			...
			if($result) {
				...
				while($row=mysql_fetch_row($result)) {
					...
					$value = "<td>$i</td>"
							...
							."<td>$row[2]</td>"
							."<td>$row[3]</td>"
							."<td>&nbsp;<a href='editcourse.php?editid=$row[0]'>Edit</a>&nbsp;</td>"
							."<td>&nbsp;<a href='delcourse.php?editid=$row[0]'>Delete</a>&nbsp;</td>";
					echo "<tr class='$class'>$value</tr>";
				}
					echo "</tbody></table>";
					echo "<p>Click <a href='list_report_course.php' target='_blank'>Here</a> To Download PDF</p>";
				}
				else
