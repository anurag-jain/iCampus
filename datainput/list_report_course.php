...
<?php  
			...
			$slQuery="SELECT coursecode,coursename,department FROM coursemaster order by coursecode";
			...
			if($result) {
				...
				if($num>0) {
					...
					echo "<td width='70px'><b>Course Code</b></td>";
					echo "<td width='300px'><b>Course Name</b></td>";
