...
<div id="content">
	...
	<div id="studenthome" class="main">
      ...
      <p>&nbsp;</p>
      <form id="form1" name="form1" method="post" action="timetable_entry2.php">
        <table width="321" border="0" align="center">
          <tr>
            <th colspan="3" align="center" valign="middle">Enter the Staff Id </th>
          </tr>
          <tr>
            <td width="107" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center" style="color:#000">Staff Id</div></td>
            <td width="144" align="center" valign="middle"><label>
              <input type="text" name="staffid" id="staffid" />
            </label></td>
            <td width="56" align="center" valign="middle"><label>
              <input type="submit" name="submit" id="submit" value="Fetch" onclick="fetch_course()" />
            </label></td>
          </tr>
        </table>
      </form>
      <br />
      <div id="staffid_div" align="center"></div>	
