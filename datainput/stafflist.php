...
<div id="content">
	...
	<!--Write code here!-->
		...
		<h2 class="heading">Staff List</h2>
		<?php  
			...
			if($result) {
				...
				if($num>0) {
					echo "<table width='650px' align='center' cellspacing='1' cellpadding='0'><tbody>";
					echo "<tr><th>S No</th>";
					echo "<th>Staff ID</th>";
					echo "<th>Staff Name</th>";
					echo "<th>Department</th>";
					echo "<th width='16px'></th></tr><tbody style='height:250px;overflow:auto'></tr>";
					$i=0;
				while($row=mysql_fetch_row($result)) {
					...
					echo "</tbody></table>";
					echo "<p>Click <a href='list_report.php' target='_blank'>Here</a> To Download PDF</p>";
				}
				else
					echo '<div class="msg">No Staff Found</div>';
			}
			else 
