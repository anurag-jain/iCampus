...
<div id="content">
	...
	<div id="studenthome" class="main">
	  <h2 class='heading'>Set CIA Lock</h2></br></br></br>
	<!--- Original Code --->
	<center>
	<form id="form_cia_post">
	<p>Staff will not be able to post CIA marks after <input id="cia_tb" name="cia_tb" type="text" size="5" maxlength="3"> days.
	</p>
    <input type="button" onClick="cia_lock_ajax()" name="submit_cia" id="submit_cia" value="Change">
	</form>
	</center>
	<!--- Original Code --->
	</div>
