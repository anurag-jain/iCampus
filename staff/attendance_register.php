    ...
    <div id="content">
      <div id="main"> <img src="../images/cont-top.png" alt="cont-top"/>
        ...
        <div id="studenthome" class="main" >
          ...
          <div align="center">
            <?php 
	 	$details=$staff->attendanceRegister();
	 ...
	 ?>
              ...
              <table width="760" border="0" align="center" cellspacing="0">
                <tr>
                  ...
                  <th width="356">Section and year</th>
                  <th width="85">Period</th>
                  <th width="121">Course</th>
                  <th width="71">View</th>
                </tr>
                <?php      
				$i=1;
...
?>
                <tr <?php if($i%2!=0) {?>class='even'<?php } else {?>class='odd'<?php }?>>
                  ...
                  <td><?php echo $row[5]."-".$row[6]."-".$row[7]."yr-".$row[4];?></td>
                  <td><?php echo $row[3];?></td>
                  <td><?php echo $row[1];?></td>
                  <td><a href="register_view.php?date=<?php echo urlencode($security->encrypt($row[0]))
		  					."&pid=".urlencode($security->encrypt($row[3])); ?>">Go</a></td>
                </tr>
                <?php $i++;}?>
              </table>
